...
This repo provides a short list of engagement opportunities and tips for students and mentory alike. We gladly accept patches to fix bugs, documentation improvements, feature requests, and even topics that should be included.
...
The primary discussion channels for this project are via [GitHub Issues](https://github.com/gt-ospo/oss-student-resources/issues).
